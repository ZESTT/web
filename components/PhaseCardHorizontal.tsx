...
const PhaseCardHorizontal = ({ phase, bgImage, phaseNumber }: Props) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16 w-full">
        <motion.div
          ...
          className={`bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-10 border-2 border-transparent bg-gradient-to-br ${borderColors[phaseNumber-1]} bg-origin-border shadow-2xl transition-all duration-500 hover:scale-[1.02]`}
        >
          <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white drop-shadow-lg">
              {phase.title}
            </h2>
            <span className="bg-black/40 px-4 py-2 rounded-full text-purple-200 font-mono border border-purple-400/50">
...
export default PhaseCardHorizontal;