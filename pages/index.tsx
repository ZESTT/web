...
const promotionalVideos = [
  { src: '/videos/hero.mp4', title: '' },
  { src: '/videos/j.mp4', title: '' },
  { src: '/videos/hp.mp4', title: '' },
];
...
const allTopics: TopicItem[] = [
  { id: 'p1t1', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'How the Web Works (Client-Server, HTTP, URLs)' },
  { id: 'p1t2', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'HTML5: Semantic Elements, Forms, Media' },
  { id: 'p1t3', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'CSS3: Selectors, Box Model, Colors, Typography' },
  { id: 'p1t4', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'CSS Layout: Flexbox, Grid, Positioning' },
  { id: 'p1t5', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'Responsive Web Design (Media Queries, Mobile First)' },
  { id: 'p1t6', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'CSS Animations & Transitions' },
  { id: 'p1t7', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'CSS Frameworks: Tailwind CSS (Utility-first)' },
  { id: 'p1t8', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'Bootstrap 5 Basics' },
  { id: 'p1t9', phaseTitle: 'Part 1: Web Fundamentals & HTML/CSS', topicTitle: 'Project: Build a Responsive Landing Page' },

  { id: 'p2t1', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'JavaScript Basics: Variables, Data Types, Operators' },
  { id: 'p2t2', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Control Flow: Conditionals, Loops' },
  { id: 'p2t3', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Functions: Declaration, Expressions, Arrow Functions' },
  { id: 'p2t4', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Scope, Hoisting, Closures' },
  { id: 'p2t5', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Arrays & Objects: Methods, Destructuring' },
  { id: 'p2t6', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'DOM Manipulation (Selectors, Events, Dynamic Content)' },
  { id: 'p2t7', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Async JavaScript: Callbacks, Promises, Async/Await' },
  { id: 'p2t8', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Fetch API & AJAX (Consuming REST APIs)' },
  { id: 'p2t9', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Error Handling (try/catch, throw)' },
  { id: 'p2t10', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Modern JavaScript (ES6+): Spread/Rest, Modules, Template Literals' },
  { id: 'p2t11', phaseTitle: 'Part 2: JavaScript Core & ES6+', topicTitle: 'Project: Interactive Dashboard with API Integration' },

  { id: 'p3t1', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'React Intro: Components, JSX, Virtual DOM' },
  { id: 'p3t2', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Functional Components & Props' },
  { id: 'p3t3', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'State Management (useState, useEffect)' },
  { id: 'p3t4', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Handling Forms & User Input' },
  { id: 'p3t5', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Conditional Rendering & Lists (map, key)' },
  { id: 'p3t6', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'React Router (SPA Navigation)' },
  { id: 'p3t7', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Context API (Global State)' },
  { id: 'p3t8', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Custom Hooks' },
  { id: 'p3t9', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Performance Optimization (memo, useCallback, useMemo)' },
  { id: 'p3t10', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Styling in React (CSS Modules, Styled Components, Tailwind)' },
  { id: 'p3t11', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'API Integration in React (Axios/Fetch)' },
  { id: 'p3t12', phaseTitle: 'Part 3: Advanced Frontend (React.js)', topicTitle: 'Project: E-commerce Frontend with Product Catalog & Cart' },

  { id: 'p4t1', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Node.js Runtime: Event Loop, Modules (CommonJS)' },
  { id: 'p4t2', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'NPM & Package Management' },
  { id: 'p4t3', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Building a Server with Express.js' },
  { id: 'p4t4', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Routing & Middleware' },
  { id: 'p4t5', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Handling Requests (GET, POST, PUT, DELETE)' },
  { id: 'p4t6', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Environment Variables & Configuration' },
  { id: 'p4t7', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'RESTful API Design' },
  { id: 'p4t8', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Error Handling & Logging' },
  { id: 'p4t9', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'File Uploads (Multer)' },
  { id: 'p4t10', phaseTitle: 'Part 4: Backend with Node.js & Express', topicTitle: 'Project: REST API for Task Manager' },

  { id: 'p5t1', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'SQL vs NoSQL (Intro to MongoDB)' },
  { id: 'p5t2', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Mongoose ODM: Schemas, Models, Queries' },
  { id: 'p5t3', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'CRUD Operations with MongoDB' },
  { id: 'p5t4', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Data Validation & Sanitization' },
  { id: 'p5t5', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Authentication: JWT (JSON Web Tokens)' },
  { id: 'p5t6', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Password Hashing (bcrypt)' },
  { id: 'p5t7', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Authorization (Roles, Permissions)' },
  { id: 'p5t8', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Session Management (express-session, cookies)' },
  { id: 'p5t9', phaseTitle: 'Part 5: Database & Authentication', topicTitle: 'Project: User Authentication API (Register, Login, Protected Routes)' },

  // Phase 6: Advanced Backend Concepts (10 topics) - excluding socket.io from main curriculum, will add as extra
  { id: 'p6t1', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Async Error Handling (Wrapper Functions)' },
  { id: 'p6t2', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Security Best Practices (Helmet, CORS, Rate Limiting)' },
  { id: 'p6t3', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Environment Split (dev, prod)' },
  { id: 'p6t4', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Email Sending (Nodemailer)' },
  { id: 'p6t5', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Payments Integration (Stripe/PayPal)' },
  { id: 'p6t6', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Caching with Redis (Optional)' },
  { id: 'p6t7', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'File Storage (Cloudinary, AWS S3)' },
  { id: 'p6t8', phaseTitle: 'Part 6: Advanced Backend Concepts', topicTitle: 'Project: Real-time Chat Application (Basic)' },
